-- CreateEnum
CREATE TYPE "UPDATE_STATUS" AS ENUM ('IN_PROGRSS', 'SHIPPED', 'DEPRECATED');
...
CREATE TABLE "Update" (
    ...
    "title" TEXT NOT NULL,
    "body" TEXT NOT NULL,
    "status" "UPDATE_STATUS" NOT NULL DEFAULT 'IN_PROGRSS',
    "version" TEXT,
    "asset" TEXT,
...
-- AddForeignKey
ALTER TABLE "UpdatePoint" ADD CONSTRAINT "UpdatePoint_id_fkey" FOREIGN KEY ("id") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
